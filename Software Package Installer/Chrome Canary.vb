...
Public Class Chrome_Canary
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel7.Hide()
        Panel1.Hide()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_a176c0e12b3d48908e3d4dbf2931fb9d.zip"), TextBox1.Text)
